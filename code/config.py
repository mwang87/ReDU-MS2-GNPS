...
PATH_TO_EIGENVALUES = "/app/temp/eigenvalues.csv" #eigenvalues for the PCA
PATH_TO_PERCENTVARIANCE = "/app/temp/percent_variance.csv" #percent variance for the orginal PCA
