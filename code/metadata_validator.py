...
def perform_validation(filename):
    validators = {
        ...
        'ATTRIBUTE_Curated_SampleType_Sub1' : [
            SetValidator(valid_set=['bacterial','beverage_alcoholic','beverage_nonalcoholic','blank_analysis','blank_extraction','blank_QC','environmental_bacteria_insitu','environmental_brackish_dissolvedorganicmatter','environmental_clothing','environmental_coral','environmental_cyanobacteria_insitu','environmental_freshwater_dissolvedorganicmatter','environmental_fungi_insitu','environmental_house','environmental_saline_dissolvedorganicmatter','environmental_soil_dissolvedorganicmatter','food_source_animal','food_source_complex','food_source_fungi','food_source_NOS','food_source_plant','fungal','not specified','plant','reference material_animalfeedorsupplement','reference material_chemicalstandard','reference material_collectionmaterial_microtubes','reference material_collectionmaterial_spotcards','reference material_collectionmaterial_swabs','reference material_collectionmaterial_wellplates','reference material_drugsorsupplement','reference material_personalcareproduct','tissue','biofluid'])
        ],
        ...
        'ATTRIBUTE_Curated_DiseaseOntologyIndex' : [
            SetValidator(valid_set=['DOID:1485','DOID:9351','disease NOS','DOID:10763','DOID:0050589','no disease reported','not applicable','DOID:8893','no DOID avaliable','no DOID avaliable','DOID:12140','DOID:9970','DOID:12155','DOID:8778','DOID:13378','DOID:0050338','no DOID avaliable','no DOID avaliable','no DOID avaliable','not applicable'
            ])
        ],
