...
df <- fread("20200504_ReDU_GroupComparator_2.csv", sep=",", header=TRUE)
...
chemicals_to_plot <- c("Surfactin_C14", "Spectral Match to PyroGlu-Ile from NIST14","Staurosporine")
...
print(plot)
ggsave(plot, file="ReDU_GroupComparator_Bacterial.pdf", width = 4.0, height = 3.0, units = "in", useDingbats=FALSE)
